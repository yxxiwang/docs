...
> hbase org.apache.hadoop.hbase.mapreduce.Import 'smartv_test_import' 'hdfs://10.0.3.41:8020/tmp/hbase_export_data/'
[...]
```
...
#!# versions 如果没有特定就设置为 1
#!# starttime/endtime 是 timestamp 单位是毫秒(13位)
> hbase org.apache.hadoop.hbase.mapreduce.Export 'smartv' 'hdfs://10.0.3.41:8020/tmp/hbase_export_data/' '1' '1507564800000' '1507651200000'
[...]
```
